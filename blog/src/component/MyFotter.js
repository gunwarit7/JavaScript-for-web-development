    ...
    constructor() {
        ...
        <section class="flex justify-between">
            <div class="flex flex-col gap-6 w-2/6">
                <h3 class="font-bold text-[32px]">John Doe</h3>
                <p>
                    Hello, beautiful passerby. I’m Jahn Doe. A passionate photographer.
                ...
                <form onsubmit="onSubmit(event)" class="flex flex-col gap-4">
                    ...
                    <button type="submit" class="bg-primary text-[#010101] px-[33px] py-3 w-1/2">
        ...
        <section>
            <p class="text-center font-bold border-t-[1px] border-primary py-12 mt-12">
